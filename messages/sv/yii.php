...
return array (
  ...
  'Column "{column}" does not exist in table "{table}".' => 'Kolumnen "{column}" finns inte i tabellen "{table}".',
  ...
  'Resetting PK sequence is not supported.' => 'Omställning PK-sekvens stöds inte.',
  'Setting integrity check is not supported.' => '"Setting integrity check" stöds inte.',
  ...
  'Virtual attribute {name} must specify "asc" and "desc" options.' => 'Det virtuella attributet {name} måste specificera alternativen  "asc" och "desc".',
