...
return array (
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 'Mối quan hệ "{relation}" trong lớp active record "{class}" có khoá ngoại "{key}" không hợp lệ. Khoá ngại không được trỏ tới bảng kết hợp.',
  ...
  'The requested controller "{controller}" does not exist.' => 'Controller "{controller}" yêu cầu không tồn tại.',
  'The requested view "{name}" is not found.' => 'View "{name}" yêu cầu không tồn tại.',
  ...
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 'Giá trị của khoá chính "{key}" không được cung cấp khi truy vấn bảng "{table}".',
  ...
  'Unable to find the decorator view "{view}".' => 'Không thể tìm được decorator view "{view}".',
  ...
  '{className} does not support flush() functionality.' => '{className} không hổ trợ chức năng flush().',
  ...
  '{class} does not have attribute "{attribute}".' => '{class} không có thuộc tính "{attribute}".',
  '{class} does not have attribute "{name}".' => '{class} không có thuộc tính nào tên "{name}".',
