...
return array (
  ...
  '{className} does not support flush() functionality.' => '{className} ne supporte pas la fonctionalité flush().',
  ...
  'CMultiFileUpload.name is required.' => 'La propriété CMultiFileUpload.name doit être définie.',
  'Column "{column} does not exist in table "{table}".' => 'La colonne « {column} » n\'existe pas dans la table « {table} ».',
  ...
  'CSecurityManager.validation must be either "MD5" or "SHA1".' => 'La propriété CSecurityManager.validation peut prendre la valeur « MD5 » ou « SHA1 ».',
  ...
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE" or "EEEEE".' => 'Le motif de définition du jour de las semaine doit être « E », « EE », « EEE », « EEEE » ou « EEEEE ».',
  ...
  'The pattern for month must be "M", "MM", "MMM", or "MMMM".' => 'Le motif de définition du mois doit être « M », « MM », « MMM » ou « MMMM ».',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 'La relation « {relation} » définie dans la classe Active record « {class} » a une clef étrangère « {key} » invalide. La clef étrangère ne pointe pas sur une table de jointure.',
