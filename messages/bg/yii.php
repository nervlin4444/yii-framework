...
return array (
  ...
  'CDbLogRoute requires database table "{table}" to store log messages.' => 'CDbLogRoute изисква таблицата "{table}", за да съхранява съобщенията от дневника.',
  ...
  'CMemCache requires PHP memcache extension to be loaded.' => 'CMemCache изисква да бъде заредено PHP memcache допълнение',
  ...
  'CMultiFileUpload.name is required.' => 'Изисква се CMultiFileUpload.name',
  ...
  'CSecurityManager.validation must be either "MD5" or "SHA1".' => 'CSecurityManager.validation трябва да бъде или "MD5" или "SHA1"(препоръчително).',
  ...
  'Cache table "{tableName}" does not exist.' => 'Таблицата за кеширане "{tableName}" не съществува.',
  ...
  'Table "{table}" does not have a primary key defined.' => 'Таблицата "{table}" няма определен първичен ключ.',
  ...
  'The "view" property is required.' => 'Изисква се стойност за свойството "view".',
  ...
  'The column "{column}" is not a foreign key in table "{table}".' => 'Полето "{column}" не е ключ в таблицата "{table}".',
  ...
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE" or "EEEEE".' => 'Шаблона за ден от седмицата, трябва да е "E", "EE", "EEE", "EEEE" или "EEEEE".',
  ...
  'The pattern for month must be "M", "MM", "MMM", or "MMMM".' => 'Шаблона за месец трябва да е "M", "MM", "MMM", или "MMMM".',
  ...
  'The relation "{relation}" in active record class "{class}" is specified with an invalid foreign key "{key}". The foreign key does not point to either joining table.' => 'Релацията "{relation}" в active record класа "{class}" е с невалидно зададен ключ "{key}". Ключа не води до която и да е от таблиците.',
  ...
  'The requested controller "{controller}" does not exist.' => 'Поискания контролер "{controller}" не е намерен.',
  'The requested view "{name}" is not found.' => 'Поискания изглед "{name}" не е намерено.',
  ...
  'The value for the primary key "{key}" is not supplied when querying the table "{table}".' => 'Стойноста на първичния ключа "{key}" не се поддържа при заявки към таблицата "{table}".',
  ...
  'Unable to find the decorator view "{view}".' => 'Грешка при търсенето на "{view}".',
  ...
  '{className} does not support flush() functionality.' => '{className} не поддържа свойството flush()',
  ...
  '{class} does not have attribute "{attribute}".' => '{class} няма свойство "{attribute}"',
  '{class} does not have attribute "{name}".' => '{class} няма свойсвто "{name}"',
