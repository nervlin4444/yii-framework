...
return array (
  '&lt; Previous' => '&lt; Vorige',
  '&lt;&lt; First' => '&lt;&lt; Eerste',
  'Active record class "{class}" does not have a scope named "{scope}".' => 'Active record class "{class}" het geen scope met naam "{scope}".',
  ...
  'Base path "{path}" is not a valid directory.' => 'Base path "{path}" is geen geldige map.',
  ...
  'Last &gt;&gt;' => 'Laatste &gt;&gt;',
  'Next &gt;' => 'Volgende &gt;',
  'Resetting PK sequence is not supported.' => 'Het resetten van een PK sequence wordt niet ondersteund.',
  'Setting integrity check is not supported.' => 'Het aanpassen van de "integrity check" wordt niet ondersteund.',
  ...
  '{attribute} cannot accept more than {limit} files.' => '{attribute} kan niet meer dan {limit} bestanden krijgen.',
  ...
  'Active record "{class}" has an invalid configuration for relation "{relation}". It must specify the relation type, the related active record class and the foreign key.' => 'Active record "{class}" heeft ongeldige instellingen voor de relatie "{relation}". Het relatie type, de verwante active record class en de foreign key moeten opgegeven zijn.',
  ...
  'Alias "{alias}" is invalid. Make sure it points to an existing directory or file.' => 'Alias "{alias}" is ongeldig. Zorg ervoor dat deze wijst naar een bestaande map of bestand.',
  ...
  'Authorization item "{item}" has already been assigned to user "{user}".' => 'Authorization item "{item}" was al aan gebruiker "{user}" toegewezen.',
  ...
  'CMultiFileUpload.name is required.' => 'CMultiFileUpload.name is vereist.',
  ...
  'The pattern for day of the week must be "E", "EE", "EEE", "EEEE" or "EEEEE".' => 'Het patroon voor weekdag moet "E", "EE", "EEE", "EEEE" of "EEEEE" zijn.',
  ...
  'Unable to create application state file "{file}". Make sure the directory containing the file exists and is writable by the Web server process.' => 'Kan het applicatie status bestand "{file}" niet aanmaken. Zorg ervoor dat de map waarin het bestand zit bestaat en beschrijfbaar is voor de web server.',
  ...
  'You are not authorized to perform this action.' => 'Het is niet toegestaan deze actie te verrichten.',
