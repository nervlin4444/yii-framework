...
return array (
  ...
  'The comment of {method} does not match its parameter declaration. Parameter {name} is not found in the method comment.' => 'Το σχόλιο στη μέθοδο {method} δεν συμφωνεί με τη δήλωση των παραμέτρων της. Η παράμετρος {name} δεν υπάρχει στο σχόλιο της μεθόδου.',
  'The {method} has {count} parameters, but {count2} are declared in the method comment.' => 'Η μέθοδος {method} έχει {count} παραμέτρους, αλλά στο σχόλιο της μεθόδου δηλώνονται {count2}.',
  ...
  'Failed to set unsafe attribute "{attribute}".' => 'Δεν ήταν δυνατός ο ορισμός του μη ασφαλούς πεδίου "{attribute}".',
  ...
  'Resetting PK sequence is not supported.' => 'Η αρχικοποίηση της PK ακολουθίας δεν υποστηρίζεται.',
  'Setting integrity check is not supported.' => 'Ο ορισμός του ελέγχου ακεραιότητας δεν υποστηρίζεται.',
  ...
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => 'Δεν ήταν δυνατή η εισαγωγή του "{alias}". Σιγουρευτείτε ότι η παραμετροποίηση του διακομιστή επιτρέπει την αλλαγή του include_path της PHP.',
